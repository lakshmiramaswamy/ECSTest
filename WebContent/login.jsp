...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/customer_onboarding","root","root");
   /* String driver = "com.mysql.jdbc.Driver";
    String connection = "jdbc:mysql://localhost:3306/customer_onboarding";
    String user = "root";
