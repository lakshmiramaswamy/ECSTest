...
<body background="<%=request.getContextPath()%>/images/bg1.jpeg"
	style="align: center; width =100%; height =100%; background-repeat: no-repeat;">
	<script>
	...
	<form onsubmit="return formValidation()" method="post"
		...
		<table>
			...
			<tr>
				...
				<td align="right"><img alt="Agility Platform Logo"
					src="<%=request.getContextPath()%>/images/AP.png" border="0"
					style="height: 80px; width: 150px; position: fixed; bottom: 0px; right: 10px;" />
				</td>
			</tr>
		...
		<table align="center">
			...
			<tr>
				<td><font color=tan size=4 face="Verdana">NAME : </font></td>
				<td><input type="text" name="Name" onclick="this.value=''" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td><font color=tan size=4 face="Verdana">EMAIL : </font></td>
				<td><input type="text" name="Email" onclick="this.value=''" /></td>
			</tr>
			<tr>
				<td><font color=tan size=4 face="Verdana">COMPANY : </font></td>
				<td><input type="text" name="Company" onclick="this.value=''" /></td>
			</tr>
			<tr>
		...
		<table align="center">
			...
			<tr>
				<td colspan="2"><font color=cornsilk size=4 face="Verdana">Already
						registered? <a href="index1.jsp">Login Here</a></td>
			</tr>
